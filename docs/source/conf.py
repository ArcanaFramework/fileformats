...
html_title = "FileFormats v{}".format(__version__)

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = 'FileFormats v<release>'
...
man_pages = [(master_doc, "fileformats", "FileFormats Documentation", [author], 1)]
